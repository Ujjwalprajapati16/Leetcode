...
public class Minimum_Cost_For_Tickets {
    ...
    public static void main(String[] args) {
        Minimum_Cost_For_Tickets obj = new Minimum_Cost_For_Tickets();
        System.out.println(obj.mincostTickets(new int[] { 1, 4, 6, 7, 8, 20 }, new int[] { 2, 7, 15 }));
        System.out
                .println(obj.mincostTickets(new int[] { 1, 2, 3, 4, 6, 7, 8, 9, 10, 30, 31 }, new int[] { 2, 7, 15 }));
    }
}

/*
 * 983. Minimum Cost For Tickets Solved Medium Topics Companies You have planned
 * some train traveling one year in advance. The days of the year in which you
 * will travel are given as an integer array days. Each day is an integer from 1
 * to 365.
 * 
