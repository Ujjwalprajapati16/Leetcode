public class Domino_and_Tromino_Tiling {
    ...
    public static void main(String[] args) {
        System.out.println(new Domino_and_Tromino_Tiling().numTilings(3)); // 5
    }
}

/*
 * 790. Domino and Tromino Tiling Solved Medium Topics Companies You have two
 * types of tiles: a 2 x 1 domino shape and a tromino shape. You may rotate
 * these shapes.
 * 
 * 
