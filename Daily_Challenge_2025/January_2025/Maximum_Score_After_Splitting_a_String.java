public class Maximum_Score_After_Splitting_a_String {
    ...
    public static void main(String[] args) {
        Maximum_Score_After_Splitting_a_String sol = new Maximum_Score_After_Splitting_a_String();
...
/*
 * 1422. Maximum Score After Splitting a String Solved Easy Topics Companies
 * Hint Given a string s of zeros and ones, return the maximum score after
 ...
 * 1 = 2 left = "01110" and right = "1", score = 2 + 1 = 3 Example 2:
 * 
 * Input: s = "00111" Output: 5 Explanation: When left = "00" and right = "111",
 * we get the maximum score = 2 + 3 = 5 Example 3:
 * 
