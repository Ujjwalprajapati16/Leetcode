...
public class Minimum_Number_of_Operations_to_Move_All_Balls_to_Each_Box {
    ...
    public static void main(String[] args) {
        Minimum_Number_of_Operations_to_Move_All_Balls_to_Each_Box solution = new Minimum_Number_of_Operations_to_Move_All_Balls_to_Each_Box();
...
/*
 * 1769. Minimum Number of Operations to Move All Balls to Each Box Solved
 * Medium Topics Companies Hint You have n boxes. You are given a binary string
