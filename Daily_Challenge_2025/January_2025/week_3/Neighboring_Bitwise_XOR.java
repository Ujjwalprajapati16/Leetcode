public class Neighboring_Bitwise_XOR {
    ...
    public static void main(String[] args) {
        Neighboring_Bitwise_XOR xor = new Neighboring_Bitwise_XOR();

        int arr[] = new int[]{1,1,0};
        System.out.println(xor.doesValidArrayExist(arr));

        int arr1[] = new int[]{1,0};
        System.out.println(xor.doesValidArrayExist(arr1));

        int arr2[] = new int[]{1, 1};
        System.out.println(xor.doesValidArrayExist(arr2));
    }
}
