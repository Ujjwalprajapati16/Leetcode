...
public class Course_Schedule_IV {
    ...
    public static void main(String[] args) {
        Course_Schedule_IV obj = new Course_Schedule_IV();
        int numCourses = 2;
        int prerequisites[][] = { { 1, 0 } };
        int queries[][] = { { 0, 1 }, { 1, 0 } };
        List<Boolean> ans = obj.checkIfPrerequisite(numCourses, prerequisites, queries);
        for (boolean i : ans) {
            System.out.print(i + " ");
        }
        ...
        queries = new int[][] { { 0, 1 }, { 1, 0 }, { 0, 0 }, { 1, 1 } };
        ans = obj.checkIfPrerequisite(numCourses, prerequisites, queries);
        for (boolean i : ans) {
            System.out.print(i + " ");
        }
...
/*
 * 1462. Course Schedule IV Solved Medium Topics Companies Hint There are a
 * total of numCourses courses you have to take, labeled from 0 to numCourses -
 ...
 * course 1, but the opposite is true. Example 2:
 * 
 ...
 * Constraints:
 * 
 * 2 <= numCourses <= 100 0 <= prerequisites.length <= (numCourses * (numCourses
 * - 1) / 2) prerequisites[i].length == 2 0 <= ai, bi <= numCourses - 1 ai != bi
 * All the pairs [ai, bi] are unique. The prerequisites graph has no cycles. 1
 * <= queries.length <= 104 0 <= ui, vi <= numCourses - 1 ui != vi
 */