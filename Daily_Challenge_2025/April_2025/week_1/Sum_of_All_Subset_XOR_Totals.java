public class Sum_of_All_Subset_XOR_Totals {
    ...
    public static void main(String[] args) {
        Sum_of_All_Subset_XOR_Totals obj = new Sum_of_All_Subset_XOR_Totals();
        int[] nums = { 1, 3 };
        ...
        System.out.println(result1); // Output: 28
    }
}

/*
 * 1863. Sum of All Subset XOR Totals Solved Easy Topics Companies Hint The XOR
 * total of an array is defined as the bitwise XOR of all its elements, or 0 if
 * the array is empty.
 * 
 ...
 * + 1 + 6 + 4 + 3 + 7 + 2 = 28 Example 3:
 * 
 * Input: nums = [3,4,5,6,7,8] Output: 480 Explanation: The sum of all XOR
 * totals for every subset is 480.
 * 
 * 
 * Constraints:
 * 
