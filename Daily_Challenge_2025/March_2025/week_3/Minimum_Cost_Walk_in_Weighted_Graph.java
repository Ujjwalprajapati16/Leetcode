...
public class Minimum_Cost_Walk_in_Weighted_Graph {
    ...
    public static void main(String[] args) {
        Minimum_Cost_Walk_in_Weighted_Graph obj = new Minimum_Cost_Walk_in_Weighted_Graph();
        int n = 5;
        int[][] edges = { { 0, 1, 7 }, { 1, 3, 7 }, { 1, 2, 1 } };
        int[][] query = { { 0, 3 }, { 3, 4 } };
        int res[] = obj.minimumCost(n, edges, query);
        for (int i : res) {
            System.out.print(i + " ");
        }
        System.out.println();
        n = 3;
        edges = new int[][] { { 0, 2, 7 }, { 0, 1, 15 }, { 1, 2, 6 }, { 1, 2, 1 } };
        query = new int[][] { { 1, 2 } };
