...
public class Check_if_Grid_can_be_Cut_into_Sections {
    ...
    public static void main(String[] args) {
        Check_if_Grid_can_be_Cut_into_Sections checker = new Check_if_Grid_can_be_Cut_into_Sections();
        int n = 5;
        int[][] rectangles = {{1,0,5,2},{0,2,2,4},{3,2,5,3},{0,4,4,5}};
        System.out.println(checker.checkValidCuts(n, rectangles)); // Output: true
