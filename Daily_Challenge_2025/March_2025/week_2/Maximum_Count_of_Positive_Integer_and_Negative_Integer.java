...
public class Maximum_Count_of_Positive_Integer_and_Negative_Integer {
    ...
    public static void main(String[] args) {
        Maximum_Count_of_Positive_Integer_and_Negative_Integer obj = new Maximum_Count_of_Positive_Integer_and_Negative_Integer();
        int[] nums = {-2, -1, -1, 1, 2, 3};
        System.out.println(obj.maximumCount(nums)); // Output: 3

        int[] nums1 = {0, 0, 0, 1, 2, 3};
        System.out.println(obj.maximumCount(nums1)); // Output: 3

        int[] nums2 = {1, 1, 0, 1};
        System.out.println(obj.maximumCount(nums2)); // Output: 4
    }
}
